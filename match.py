...
>>>>>>> 98904a3da4d6a8ba916b9ca6e04f56de5b567cb9
...
=======
dental_product_class = conn.createURI("http://www.semanticweb.org/ontologies/2022/titutuli/nivedita/drmo#DentalMaterialProduct")
is_about_product_prop = conn.createURI('http://www.semanticweb.org/ontologies/2022/titutuli/nivedita/drmo#isAboutProduct')
label_property = conn.createURI('http://www.w3.org/2000/01/rdf-schema#label')
is_about_prop = conn.createURI('http://www.semanticweb.org/ontologies/2022/titutuli/nivedita/drmo#isAbout')
document_class = conn.createURI('http://www.semanticweb.org/ontologies/2022/titutuli/nivedita/drmo#Document')
...
def create_products_links():
    for product_statement in conn.getStatements(None, rdf_type, dental_product_class):
        product = product_statement[0]
        product_labels = conn.getStatements(product, label_property, None)
